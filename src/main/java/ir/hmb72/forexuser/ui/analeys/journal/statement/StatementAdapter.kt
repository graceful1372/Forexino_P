...
import ir.hmb72.forexuser.databinding.ItemListStatementBinding
...
class StatementAdapter @Inject constructor() : RecyclerView.Adapter<StatementAdapter.ViewHolder>() {

    private lateinit var binding: ItemListStatementBinding
    private var items = emptyList<NoteEntity>()
    private lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        binding = ItemListStatementBinding.inflate(inflater, parent, false)
        ...
        fun bind(item: NoteEntity) {
            ...
            binding.apply {
                ...
                if (item.result > 0) {
                    ...
                    resultTxt.setTextColor(ContextCompat.getColor(context, R.color.red))
                    resultTxt.text = item.result.toString()
